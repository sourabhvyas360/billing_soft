...
function getTable() {
    $.ajax({
        ...
        success: function (data) {
            ...
            console.log($(material[0]).find("CategoryName").text());
...
$(document).ready(function () {
    ...
    $('#btnBuy').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "BuyNowPage.aspx/BuyNow",
            data: JSON.stringify({ Itemid: a, Quantity: b }),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    $('#btngenerate').click(function () {
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                window.alert("Error generating PDF: " + xhr.responseText);
            }
        });
    });
});
